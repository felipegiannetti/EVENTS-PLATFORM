...
| `/eventos/[id]/lista-off` | **Gestão da lista off** — cria/edita/remove listas com horário limite opcional, importa até 1.000 pessoas no formato `NOME, CPF`, pesquisa, pagina, edita e remove convidados |
